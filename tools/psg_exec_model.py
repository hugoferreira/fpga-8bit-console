...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="write the exact H095-to-I001 combined source boundary")
...
def main() -> int:
    ...
    if args.rtl_source_contract_out:
        print("RTL source contract: " + write_h095_r84_source_contract(
