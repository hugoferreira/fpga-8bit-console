...
module top(input  bit clk,
  ...
  wire pllclk, pllclk_div32, pll_locked;
  ...
  // THE ONE UNDER TEST. pllclk_div32 is the rPLL's CLKOUTD - 112.5/32 =
  // 3.515625 MHz - and it is what feeds masterclk, videoclk and cpuclk in the
  ...
  //   3.515625 MHz / 2^22 = 0.84 Hz, about the same rate as the raw counter.
  logic [22:0] fromdiv32 = 0;
  always_ff @(posedge pllclk_div32) fromdiv32 <= fromdiv32 + 1'b1;
  ...
  wire unused = &{key1, key2, pll_locked, raw[21:16], frompll[25:0], fromdiv32[21:0]};
