...
type_tile:
    #d8 0,  16,  20,  28,  32,  36,  24
type_hi:
    #d8 0, $0C, $0C, $0C, $0C, $0C, $0C
type_pts:
    #d8 0, $10, $20, $30, $00, $50, $20
type_next:
    #d8 0,   0,   6,   0,   4,   0,   0

; paddle-english zones: (vx, vy) in signed 8.8
zone_vx_lo: #d8 $C0, $40, $40, $C0, $40
zone_vx_hi: #d8 $FE, $FF, $00, $00, $01
zone_vy_lo: #d8 $40, $C0, $80, $C0, $40
zone_vy_hi: #d8 $FF, $FE, $FE, $FE, $FF
...
set_vec:
    ...
    rts
times13:  #d8 0, 13, 26
zone_ang: #d8 1, 4, 6, 8, 11

; spark color by brick type (sprite flags: pal<<4, 1bpp)
type_spark:
    #d8 $60, $D0, $60, $80, $60, $B0, $60
burst_vx: #d8 $01, $FF, $02, $FE
burst_vy: #d8 $FF, $FF, $01, $01
shake_tbl:
    #d8 0, 1, $FF, 2, $FE, 1, $FF, 2

times11:
    #d8 0, 11, 22, 33, 44, 55, 66, 77, 88, 99

rowmap_lo:
    #d8 $00, $20, $40, $60, $80, $A0, $C0, $E0, $00, $20, $40, $60, $80, $A0, $C0, $E0
rowmap_hi:
    #d8 $F0, $F0, $F0, $F0, $F0, $F0, $F0, $F0, $F1, $F1, $F1, $F1, $F1, $F1, $F1, $F1
rowmap2_lo:
    #d8 $40, $60, $80, $A0, $C0, $E0, $00, $20, $40, $60
rowmap2_hi:
    #d8 $F0, $F0, $F0, $F0, $F0, $F0, $F1, $F1, $F1, $F1

lvl_tens:
    #d8 $B0, $B0, $B0, $B0, $B0, $B0, $B0, $B0, $B0, $B1, $B1, $B1, $B1, $B1, $B1
lvl_ones:
    #d8 $B1, $B2, $B3, $B4, $B5, $B6, $B7, $B8, $B9, $B0, $B1, $B2, $B3, $B4, $B5
...
font46:
    #d8 $02, $05, $07, $05, $05, $00   ; 0  A
    #d8 $07, $01, $03, $01, $07, $00   ; 6  E
    #d8 $07, $01, $05, $05, $07, $00   ; 12 G
    #d8 $05, $07, $07, $05, $05, $00   ; 18 M
    #d8 $07, $05, $05, $05, $07, $00   ; 24 O
    #d8 $03, $05, $03, $01, $01, $00   ; 30 P
    #d8 $03, $05, $03, $05, $05, $00   ; 36 R
    #d8 $07, $01, $07, $04, $07, $00   ; 42 S
    #d8 $05, $05, $05, $05, $02, $00   ; 48 V
    #d8 $05, $05, $02, $05, $05, $00   ; 54 X
    #d8 $00, $00, $00, $00, $00, $00   ; 60 space
    #d8 $03, $05, $03, $05, $03, $00   ; 66 B
    #d8 $07, $01, $01, $01, $07, $00   ; 72 C
    #d8 $03, $05, $05, $05, $03, $00   ; 78 D
    #d8 $07, $01, $03, $01, $01, $00   ; 84 F
    #d8 $05, $05, $07, $05, $05, $00   ; 90 H
    #d8 $07, $02, $02, $02, $07, $00   ; 96 I
    #d8 $05, $05, $03, $05, $05, $00   ; 102 K
    #d8 $01, $01, $01, $01, $07, $00   ; 108 L
    #d8 $03, $05, $05, $05, $05, $00   ; 114 N
    #d8 $07, $02, $02, $02, $02, $00   ; 120 T
    #d8 $05, $05, $05, $05, $07, $00   ; 126 U
    #d8 $05, $05, $07, $07, $05, $00   ; 132 W
    #d8 $05, $05, $02, $02, $02, $00   ; 138 Y

msg_press_t:
    #d8 30, 36, 6, 42, 42, 60, 54, 60          ; PRESS X
msg_over_t:
    #d8 12, 0, 18, 6, 60, 24, 48, 6, 36, 60    ; GAME OVER

; pill sash / event messages (glyph-offset pairs)
msg_slow_t:  #d8 42, 108, 24, 132, 78, 24, 132, 114              ; SLOWDOWN
msg_life_t:  #d8 108, 96, 84, 6, 60, 126, 30, 60                 ; LIFE UP
msg_stick_t: #d8 42, 120, 96, 72, 102, 138                       ; STICKY
msg_exp_t:   #d8 6, 54, 30, 0, 114, 78                           ; EXPAND
msg_red_t:   #d8 36, 6, 78, 126, 72, 6                           ; REDUCE
msg_mega_t:  #d8 18, 6, 12, 0, 66, 0, 108, 108                   ; MEGABALL
msg_multi_t: #d8 18, 126, 108, 120, 96, 66, 0, 108, 108, 60      ; MULTIBALL
msg_sd_t:    #d8 42, 126, 78, 78, 6, 114, 60, 78, 6, 0, 120, 90  ; SUDDEN DEATH
msg_win_t:   #d8 138, 24, 126, 60, 132, 96, 114, 60              ; YOU WIN
msg_txt_lo:
    #d8 msg_slow_t[7:0], msg_life_t[7:0], msg_stick_t[7:0], msg_exp_t[7:0], msg_red_t[7:0]
    #d8 msg_mega_t[7:0], msg_multi_t[7:0], msg_sd_t[7:0], msg_win_t[7:0]
msg_txt_hi:
    #d8 msg_slow_t[15:8], msg_life_t[15:8], msg_stick_t[15:8], msg_exp_t[15:8], msg_red_t[15:8]
    #d8 msg_mega_t[15:8], msg_multi_t[15:8], msg_sd_t[15:8], msg_win_t[15:8]
msg_pairs:
    #d8 4, 4, 3, 3, 3, 4, 5, 6, 4
...
zthr3:     #d8 18, 23, 13
zthr4:     #d8 24, 30, 18
pmin_tbl:  #d8 16, 20, 12
pmax_tbl:  #d8 80, 76, 84
...
pill_flags: #d8 $80, $60, $A0, $B0, $70, $D0, $90
; explosion neighbour offsets
nb_dr: #d8 $FF, $FF, $FF, 0, 0, 1, 1, 1
nb_dc: #d8 $FF, 0, 1, $FF, 1, $FF, 0, 1
